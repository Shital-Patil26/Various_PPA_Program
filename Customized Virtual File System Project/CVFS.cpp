...
void man(char *name)
{
    ...
    else if(strcmp(name,"read") == 0)
    {
        ...
        printf("Usage : read File_name No_Of_Byteas_To_Read\n");
    }
    else if(strcmp(name,"write") == 0)
    {
        printf("Decription : Used to write into regular file\n");
        printf("Usage : write File_name\n After this enter the data that we want to create\n");
    }
...
void DisplayHelp()
{
    ...
    printf("write : To writes contents into file\n");
    printf("exit : To Terminate file syatem\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminatin the Marvellous Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count == 2)
        {
            ...
            else  if(strcmp(command[0],"write") == 0)
            {
                ...
                scanf("%[^\n]s",arr);   //here me add s not in pdf
                ...
                if(ret == -2)
                    printf("ERROR : There is nosufficient memory to write\n");
                if(ret == -3)
                    printf("ERROR : It is not reular file\n");
            }
        ...
        { 
            ...
            {
                //create Demo.txt   3  {3 means read+write mode (1+2)}
