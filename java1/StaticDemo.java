...
class StaticDemo
{
    static
    {
        System.out.println("Inside Static block of staticDemo of class which contains main");
    }
    public StaticDemo()
    {
...
class Demo
{
    ...
    static          //static block
    {
        System.out.println("Inside static block Demo class");
        No3 = 51;
        No4 = 101;
    }
    public Demo()
    ...
    public void Fun()
    {
        //this keyword is applicable only Non-static method
