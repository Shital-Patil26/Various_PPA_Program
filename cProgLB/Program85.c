//accept array of n numbers and find last occurance of given number
...
int main()
{
    ...
    // Step 4 : Call the function
     ...
     {
        printf("%d is occured in the array last index : %d \n",iValue,iRet);
     }
...
//if no elements found then icnt is equal to iSize else if found then break 